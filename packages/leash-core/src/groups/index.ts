...
export const TOOL_GROUPS: ToolGroup[] = [homeAssistantGroup, feedGroup, memoryGroup, tasksGroup, contextGroup, photosGroup, imageGroup, researchGroup, skillsGroup, computerGroup, filesGroup, mcpAdminGroup];
