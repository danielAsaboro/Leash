 ...
 * the /tasks dashboard and vice versa. The persisted store keeps its historical task
 * type names; chat-facing copy calls these todos because they render as checkable items.
 *
