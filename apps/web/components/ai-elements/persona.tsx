...
const sources = {
  ...
  // Vendored locally (public/persona/*.riv) so the call avatar animates OFFLINE — the upstream
  // component fetches these from vercel-storage at runtime, which would break airplane-mode.
  obsidian: {
    dynamicColor: true,
    hasModel: true,
