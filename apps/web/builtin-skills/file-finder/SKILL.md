...
when_to_use: |
  ...
  grep my documents for anything about the Henderson contract
...
This is for the user's OWN files. For Apple Notes, memories, and past chats as a knowledge graph, the context-grounding tools may fit better; for the live web, use research.
