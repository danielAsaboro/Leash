...
description: Ground answers in the user's OWN private context — their notes, files, saved memories, and past chats (a searchable knowledge graph), plus what's currently on their screen. Use this WHENEVER a question is about the user's own world ("what did I decide about…", "summarize my notes on…", "what was I just doing", "based on my stuff…") rather than general knowledge or the open web. Search their context before answering so the reply is theirs, not generic.
builtin: true
...
when_to_use: |
  ...
  based on my own notes, what are the open questions on this
